using System;
using CatalogScolar.Infrastructure.Configuration;
...
using CatalogScolar.Domain.Services;
...
using AuthenticationService = CatalogScolar.Domain.Services.AuthenticationService;
using IAuthenticationService = CatalogScolar.Domain.Services.Interfaces.IAuthenticationService;
