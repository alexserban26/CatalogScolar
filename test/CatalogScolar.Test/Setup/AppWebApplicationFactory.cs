...
using CatalogScolar.Configuration;
using CatalogScolar.Security;
using CatalogScolar.Test.Configuration;
...
namespace CatalogScolar.Test.Setup;
    ...
    where TEntryPoint : class, IStartup, new()
{
    ...
    {
        builder
            .UseSolutionRelativeContentRoot("src/CatalogScolar")
